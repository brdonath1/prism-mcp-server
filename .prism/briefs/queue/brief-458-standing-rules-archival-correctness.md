...
# Brief 458 — W3-S3: standing-rules parser/writer + archival correctness (M-008/M-006)

**Status: PENDING**
**Repo:** prism-mcp-server
**Origin:** prism D-257 wave 3 (dispatched S171). Execution queue: `.prism/audits/s168-wave3-backlog.md` on brdonath1/prism · master ledger: `.prism/audits/s168-master-findings.md` (same repo). Re-issues brief-457 verbatim — 457 went preflight-terminal on brief-456 clone residue (INS-330); the clone is verified back on clean main.
